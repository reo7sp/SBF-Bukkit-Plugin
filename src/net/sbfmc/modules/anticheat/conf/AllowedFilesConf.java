...
public class AllowedFilesConf extends DefaultConf {
	...
	public void saveConf() throws IOException {
		...
		for (String fileName : module.getAllowedFiles()) {
	...
	public void initConf() throws IOException {
		confFile = new File(SBFPlugin.getPlugin().getDataFolder(), "allowedFiles.txt");
		createConf();
	}
