...
public class EnableModuleCommand extends Command {
	@Override
	public void exec(CommandSender sender, String[] args) throws Exception {
		if (args.length > 0) {
			...
			sender.sendMessage(ChatColor.RED + "/sbf admin enablemodule (modon) ID_МОДУЛЯ");
			sender.sendMessage(ChatColor.RED + "/sbf admin enablemodule (modon) ИМЯ_МОДУЛЯ");
		}
	}
