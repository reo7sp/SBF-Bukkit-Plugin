...
public class SaveConfCommand extends Command {
	...
	public void exec(CommandSender sender, String[] args) throws Exception {
		for (PlayerSession session : module.getPlayerSessions()) {
			module.getPlayersConf().savePlayer(session);
		}

		sender.sendMessage(ChatColor.GREEN + "Players conf сохранён");
	}
