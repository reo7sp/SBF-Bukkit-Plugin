...
public class GenChangeCommand extends Command {
	@Override
	public void exec(CommandSender sender, String[] args) throws Exception {
		NormalGeneration.setGenChange(!NormalGeneration.isGenChange());
		sender.sendMessage(ChatColor.GREEN + "GenChange " + NormalGeneration.isGenChange() + "!");
	}
